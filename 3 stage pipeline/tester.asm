...
ADDU  $R5,%ONE
.const %SHIFT_INP_2, 0x09070021
.const %SLCR_ANS_2, 0x120E0042
MOV   $R7,%SHIFT_INP_2
SLCR  $R7,%ONE
MOV   $R6,%SLCR_ANS_2
JALR  $R1,%CHECK
...
ADDU  $R5,%ONE
.const %SLCR_ANS_3, 0x90700210
MOV   $R7,%SHIFT_INP_2
SLCR  $R7,%FOUR
MOV   $R6,%SLCR_ANS_3
JALR  $R1,%CHECK

.const %SLCR_ANS_4, 0x00000008
ADDU  $R5,%ONE
MOV   $R7,%SHIFT_INP
SLCR  $R7,%FOUR
MOV   $R6,%SLCR_ANS_4
...
.const %SRCR_ANS_3, 0x84838010
ADDU  $R5,%ONE
MOV   $R7,%SHIFT_INP_2 // 0x09070021
SRCR  $R7,%ONE
MOV   $R6,%SRCR_ANS_3
JALR  $R1,%CHECK
