...
BIGSIG0:
	...
	ADDU $R8, %S10
	SRCR $R3, $R8    // RR(x,13)
	MYXOR $R2, $R3   // RR(x,2) xor RR(x,13)
	MOV $R3, %S11
	ADDU $R3, %S11   
	SRCR $R1, $R3    // rr(x,22)
	MYXOR $R2, $R1   // (RR(x,2) xor RR(x,13)) xor RR(x,22)
	JALR $R31, $R30
...
BIGSIG1:
	...
	MOV $R3, $R1
	SRCR $R3, %S11 // RR(x,11)
	MYXOR $R2, $R3 // RR(x,6) xor RR(x,11)
	SRCR $R1, %S25 // RR(x,25)
	MYXOR $R2, $R1 // RR(x,6) xor RR(x,11) xor RR(x,25)
    JALR $R31, $R30
...
SMSIG0:
	...
	MOV $R3, $R1
	SRCR $R3, %S18 // RR(x,18)
	MYXOR $R2, $R3 // RR(x,7) xor RR(x,18)
	SRLV $R1, %S3  // RR(x,3)
	MYXOR $R2, $R1 // RR(x,7) xor RR(x,18) xor RR(x,3)
    JALR $R31, $R30
...
SMSIG1:
	...
	MOV $R3, $R1
	SRCR $R3, %S19 // RR(x,19)
	MYXOR $R2, $R3 // RR(x,17) xor RR(x,19)
	SRLV $R1, %S10 // RR(x,10)
	MYXOR $R2, $R1 // RR(x,17) xor RR(x,19) xor RR(x,10)
    JALR $R31, $R30
